...
class FoodTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_type" do
    assert_difference("FoodType.count") do
      post food_types_url, params: { food_type: { category: @food_type.category, foods_id: @food_type.foods_id, image: @food_type.image, name: @food_type.name, price: @food_type.price, size: @food_type.size } }
    end
  ...
  test "should update food_type" do
    patch food_type_url(@food_type), params: { food_type: { category: @food_type.category, foods_id: @food_type.foods_id, image: @food_type.image, name: @food_type.name, price: @food_type.price, size: @food_type.size } }
