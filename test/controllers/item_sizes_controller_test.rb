...
class ItemSizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_size" do
    assert_difference("ItemSize.count") do
      post item_sizes_url, params: { item_size: { index: @item_size.index, name: @item_size.name, price: @item_size.price } }
    end
  ...
  test "should update item_size" do
    patch item_size_url(@item_size), params: { item_size: { index: @item_size.index, name: @item_size.name, price: @item_size.price } }
