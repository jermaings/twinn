class ItemSizesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to item_sizes_path, status: :see_other, notice: "Item size was successfully destroyed." }
  ...
  private
    ...
    def set_item_size
      @item_size = ItemSize.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def item_size_params
      params.expect(item_size: [ :name, :price ])
    end
end
